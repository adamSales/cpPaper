...
\Sexpr{round(tab['Year 1','Problems']-tab['Year 2','Problems'])}, and
the median number of sections decreased by
\Sexpr{round(tab['Year 1','Sections']-tab['Year 2','Sections'])} from
years 1 to 2.
...
The magnitudes of the effects are rather large: \citet{pane2014effectiveness} reported an effect, in year 2, of about 0.2; the estimated effect of at least one reassignment is \Sexpr{round(abs(adjustedEsts1[['mod3.1']][1,'ests'])/0.2*100)}\% of that.
