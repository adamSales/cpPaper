...
ggplot(subset(xirtDat,state!='NJ'),aes(xirt,propCP,size=nsec))+geom_point()+geom_line(aes(xirt,fitted),col='red')+facet_grid(year~state)+coord_cartesian(ylim=c(0,0.05))
